...
INSERT INTO course (name, description, icon) 
VALUES ( 'Radio Buttons', 'Learn to identify an icon representing one of a set of options, only one of which can be selected at any time.', 'radio-button-on' );

INSERT INTO course (name, description, icon) 
VALUES ( 'Combo Boxes', 'Learn to identify a type of dialogue box containing a combination of controls, such as sliders, text boxes, and drop-down lists.', 'arrow-dropdown-circle' );

INSERT INTO course (name, description, icon) 
VALUES ( 'Check Boxes', 'Learn to identify a small box on a form into which a tick or other mark is entered as the response to a question', 'checkbox' );
...
INSERT INTO template (content_type, content_prefix, content_style, name) VALUES ( 'COMBOBOX', 'Identify and select the correct option', 'NORMAL', 'COMBO_NORMAL' );

INSERT INTO template (content_type, content_prefix, content_style, name) VALUES ( 'RADIOBUTTON', 'Identify and select the correct option', 'NORMAL', 'RADIO_NORMAL' );

INSERT INTO template (content_type, content_prefix, content_style, name) VALUES ( 'CHECKBOX', 'Identify and select the correct options', 'NORMAL', 'CHECK_NORMAL' );